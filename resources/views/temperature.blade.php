...
@section('body')
                  ...
                  <h3><center>Temperature Guide</center>
               </h3>
               <div>
...
<br>
Located on the same latitude as the Hawaiian Islands (20ºN), the city's weather and climate are often compared to Hawaii's (City information). Puerto Vallarta (like Nuevo Vallarta) is surrounded by jungle, and receives considerable rain during the summer months.

 </p>

 <div class="col-sm-6 col-lg-8 col-md-8 photography graphicdesign ">
                     <div class="gal-detail thumb box-shadow">
                        <img src="images/hawai.png" class="thumb-img" alt="work-thumbnail">
                        </a></div>
                        <br>
                     <br>
                  </div>
...
<p class="text-">While rain can spoil a day at the beach, tropical storms can be quite beautiful and amazing, when rain seems to march across the hills and lightning illuminates the humid sky while the thick clouds advance inland from the Bay.</p>
 ...
 <div class="col-sm-6 col-lg-12 col-md-12 photography graphicdesign ">
                     <div class="gal-detail thumb box-shadow">
                        <img src="images/temperatureguide.png" class="thumb-img" alt="work-thumbnail">
                        </a></div>
                        <br>
                     <br>
                  </div>
